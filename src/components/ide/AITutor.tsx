...
/**
 * PERFORMANCE: Memoized to prevent re-renders when the code state in Workspace changes.
 * The suggestion depends only on the lesson track/mode which is stable during editing.
 */
