...
/**
 * AITutor provides contextual suggestions.
 * Memoized as it only depends on the lesson structure.
 */
export default React.memo(function AITutor({ lesson }: AITutorProps) {
  const getSuggestion = () => {
