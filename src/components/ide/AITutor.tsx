...
/**
 * PERFORMANCE: Wrapped in React.memo to prevent redundant re-renders.
 * The AI suggestions are stable for a given lesson and don't need
 * to re-calculate as the user edits their code.
 */
