...
/** PERFORMANCE: React.memo prevents AITutor from re-rendering during keystrokes.
 * Expected impact: Reduces re-renders from 1 per keystroke to 0 during typing sessions.
 */
