...
/**
 * PERFORMANCE: React.memo prevents AITutor from re-rendering during code updates.
 * This panel only depends on the lesson metadata which is stable during a session.
 */
