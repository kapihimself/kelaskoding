...
/**
 * ⚡ Bolt Optimization:
 * Memoizing AITutor prevents it from re-rendering on every keystroke in the Editor.
 * AI suggestions are static for each lesson.
 */
const AITutor = React.memo(({ lesson }: AITutorProps) => {
  const getSuggestion = () => {
