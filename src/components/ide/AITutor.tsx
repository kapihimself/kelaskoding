...
/**
 * AITutor provides contextual help based on the lesson track.
 * Wrapped in React.memo as its content is based on lesson props and doesn't
 * change when the user types in the editor.
 */
