...
/**
 * PERFORMANCE: Wrapped in React.memo to prevent unnecessary re-renders when the user
 * types in the editor. This component only needs to re-render when the lesson,
 * error state, or success state changes.
 */
