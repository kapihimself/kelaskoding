...
/**
 * MaterialPanel renders lesson instructions and feedback.
 * Memoized to prevent re-renders during typing sessions.
 */
export default React.memo(function MaterialPanel({ lesson, error, isSuccess }: MaterialPanelProps) {
  return (
