...
/** PERFORMANCE: Memoizing MaterialPanel prevents redundant re-renders
 * during high-frequency events like typing in the editor,
 * as its props remain stable during code changes. */
