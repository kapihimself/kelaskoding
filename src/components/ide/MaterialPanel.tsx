...
/** PERFORMANCE: memo prevents the MaterialPanel from re-rendering when the user types
 * in the editor sibling, as its props only change on lesson switches or run events. */
