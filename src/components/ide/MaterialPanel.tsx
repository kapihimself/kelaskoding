...
/**
 * PERFORMANCE: React.memo prevents MaterialPanel from re-rendering when the user types
 * in the EditorPanel. It only re-renders if lesson, error, or success status changes.
 */
