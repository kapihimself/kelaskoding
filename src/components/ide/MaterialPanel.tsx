...
/**
 * PERFORMANCE: React.memo prevents MaterialPanel from re-rendering when the user
 * types in the EditorPanel, as its props (lesson, error, isSuccess) remain stable.
 */
