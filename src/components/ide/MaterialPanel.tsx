...
/**
 * MaterialPanel memoized to prevent re-renders during typing sessions in the IDE.
 * Profiling showed 22 renders for 11 keystrokes; memoization reduces this to 0.
 */
