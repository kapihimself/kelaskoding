...
/**
 * MaterialPanel renders static lesson content and instructions.
 * Wrapped in React.memo to prevent re-renders during code editing sessions
 * in the parent Workspace component.
 */
