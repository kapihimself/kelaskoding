...
/**
 * PERFORMANCE: Wrapped in memo to prevent re-renders when the parent Workspace
 * code state changes during typing. Only re-renders if lesson, error, or isSuccess changes.
 */
