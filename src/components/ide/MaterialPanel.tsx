...
/**
 * MaterialPanel is memoized to prevent re-renders when the parent (Workspace)
 * state changes (e.g., during typing in the editor), as long as its props remain the same.
 */
