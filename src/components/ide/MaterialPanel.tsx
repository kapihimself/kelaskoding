...
/**
 * MaterialPanel component renders the lesson content, instructions, and feedback.
 * Wrapped in React.memo to prevent unnecessary re-renders when parent Workspace state (like code) changes.
 */
