...
/** PERFORMANCE: Prevents expensive re-renders of the material panel while typing.
 * Expected impact: Reduces re-renders from 1 per keystroke to 0 during typing session. */
