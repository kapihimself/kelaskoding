...
/**
 * MaterialPanel component displays the lesson content, instructions, and feedback.
 * Memoized to prevent re-renders during code editing when props haven't changed.
 */
