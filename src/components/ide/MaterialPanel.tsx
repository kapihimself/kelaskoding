...
/**
 * MaterialPanel is memoized to prevent re-renders when the user is typing in the editor.
 * It only re-renders when the lesson, error state, or success state changes.
 */
