...
/**
 * PERFORMANCE: Wrapped in React.memo to prevent re-renders when the parent
 * Workspace state (code) changes. This component only depends on lesson,
 * error, and isSuccess states.
 */
