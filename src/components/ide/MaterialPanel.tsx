...
/**
 * MaterialPanel displays the lesson content, instructions, and feedback.
 * Wrapped in React.memo to prevent re-renders when other workspace state (like code) changes.
 */
