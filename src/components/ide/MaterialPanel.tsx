...
/**
 * MaterialPanel displays lesson content, tasks, and feedback.
 * Wrapped in React.memo to prevent unnecessary re-renders during typing sessions
 * in the neighboring EditorPanel.
 */
