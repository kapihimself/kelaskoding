...
/**
 * MaterialPanel is memoized to prevent re-renders during high-frequency typing
 * in the EditorPanel, as it only depends on lesson content and validation state.
 */
