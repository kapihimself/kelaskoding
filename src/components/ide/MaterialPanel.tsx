...
/**
 * MaterialPanel is memoized to prevent re-renders during typing sessions.
 * It only updates when the lesson content changes or when a validation result (error/isSuccess) is returned.
 */
