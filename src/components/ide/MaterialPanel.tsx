...
/**
 * ⚡ Bolt Optimization:
 * Memoizing MaterialPanel prevents unnecessary re-renders when typing in the editor.
 * The lesson content only changes when the user navigates between lessons.
 */
const MaterialPanel = React.memo(({ lesson, error, isSuccess }: MaterialPanelProps) => {
  return (
