...
/**
 * ⚡ BOLT OPTIMIZATION:
 * Wrapped in React.memo to prevent unnecessary re-renders when the parent Workspace
 * re-renders during typing in the editor. This component only depends on props
 * that change when the lesson is switched or "Jalankan" is clicked.
 */
