...
/**
 * Optimization: Wrapped in React.memo to prevent re-renders when the user types in the editor.
 * Expected impact: Reduces re-renders from 2 per keystroke to 0 during typing.
 */
