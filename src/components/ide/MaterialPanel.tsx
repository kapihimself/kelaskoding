...
/**
 * MaterialPanel component is memoized to prevent unnecessary re-renders
 * during typing sessions in the EditorPanel. It only re-renders when
 * the lesson content, error status, or success status changes.
 */
