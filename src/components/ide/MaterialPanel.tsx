...
/**
 * MaterialPanel is memoized to prevent unnecessary re-renders when the parent Workspace
 * re-renders on every keystroke in the editor. Since the lesson content is static
 * during a lesson session, this optimization significantly reduces main thread load.
 */
const MaterialPanel = React.memo(function MaterialPanel({ lesson, error, isSuccess }: MaterialPanelProps) {
  console.log('[RENDER] MaterialPanel');
  return (
