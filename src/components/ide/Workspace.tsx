...
/**
 * Workspace is the main container for the interactive coding environment.
 * It manages the code state, execution logic, and layout of the IDE.
 */
export default function Workspace({ lesson, nextLessonId, trackId }: WorkspaceProps) {
  ...
  // Decouple code updates from heavy preview renders
