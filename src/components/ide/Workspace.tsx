...
export default function Workspace({ lesson, nextLessonId, trackId }: WorkspaceProps) {
  ...
  /**
   * PERFORMANCE: useDeferredValue for code to ensure that typing remains fluid.
   * PreviewPanel is wrapped in React.memo and will only re-render when this
   * deferred value eventually updates, preventing heavy iframe re-renders
   * from blocking the main thread during typing.
   */
