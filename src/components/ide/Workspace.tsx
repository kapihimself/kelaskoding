...
export default function Workspace({ lesson, nextLessonId, trackId }: WorkspaceProps) {
  ...
  /**
   * PERFORMANCE: Defer code updates to the PreviewPanel to ensure
   * the editor remains responsive during typing. This decouples
   * immediate keystroke feedback from the heavier preview rendering.
   */
