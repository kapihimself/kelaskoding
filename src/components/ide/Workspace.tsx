...
/**
 * Workspace component manages the IDE state, integrating Material, Editor, and Preview panels.
 * Optimized with useDeferredValue for code updates to keep the editor responsive during typing.
 */
