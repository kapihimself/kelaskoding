...
export default function Workspace({ lesson, nextLessonId, trackId }: WorkspaceProps) {
  ...
  /** PERFORMANCE: useDeferredValue decouples the high-frequency editor typing
   * from the heavier preview panel updates, ensuring smooth typing even on complex lessons.
   */
