...
/**
 * Workspace is the main container for the interactive IDE.
 * Optimizations implemented:
 * 1. useCallback for event handlers to maintain stable references for memoized children.
 * 2. useDeferredValue for code passed to PreviewPanel to ensure editor remains responsive.
 */
