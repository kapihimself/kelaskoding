...
export default function Workspace({ lesson, nextLessonId, trackId }: WorkspaceProps) {
  ...
  // Optimization: useDeferredValue for the code state to decouple typing
  // in the editor from the more expensive preview rendering.
  // Expected impact: Reduces main thread blocking and avoids lag during typing.
