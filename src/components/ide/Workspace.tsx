...
export default function Workspace({ lesson, nextLessonId, trackId }: WorkspaceProps) {
  ...
  /**
   * ⚡ BOLT OPTIMIZATION:
   * We use useDeferredValue for the code passed to the PreviewPanel.
   * This ensures that the heavy iframe-based live preview update doesn't
   * block the UI thread during typing in the editor, keeping it responsive.
   */
