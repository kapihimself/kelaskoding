...
export default function Workspace({ lesson, nextLessonId, trackId }: WorkspaceProps) {
  ...
  // ⚡ Bolt Optimization:
  // Defer code updates for the PreviewPanel to keep the EditorPanel (Monaco) responsive.
  // This allows the high-priority UI update (typing in the editor) to happen instantly
  // while the preview update (which might be heavy) is processed in the background.
