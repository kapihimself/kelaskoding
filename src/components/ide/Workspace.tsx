...
/**
 * Workspace is the main IDE component.
 * Optimized with useDeferredValue and useCallback to ensure smooth typing.
 */
export default function Workspace({ lesson, nextLessonId, trackId }: WorkspaceProps) {
  const [code, setCode] = useState(lesson.initialCode);

  // Use deferred value for the code to keep the editor responsive while
  // the preview and validation can happen with lower priority.
