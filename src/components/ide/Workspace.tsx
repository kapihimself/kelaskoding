...
export default function Workspace({ lesson, nextLessonId, trackId }: WorkspaceProps) {
  // Optimization: Use deferred value for the code to prioritize editor responsiveness
  // Expected impact: Decouples heavy PreviewPanel updates from the immediate typing state
