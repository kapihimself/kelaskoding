...
/**
 * ⚡ BOLT OPTIMIZATION:
 * Wrapped in React.memo and receives a deferredValue of 'code' from the parent.
 * This prevents the iframe from updating on every single keystroke, reducing
 * layout shifts and CPU usage during typing.
 */
