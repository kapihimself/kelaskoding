...
/**
 * PERFORMANCE: React.memo combined with useDeferredValue in the parent
 * ensures that the PreviewPanel only updates when the main thread is idle,
 * preventing layout thrashing during rapid typing.
 */
