...
/**
 * PreviewPanel is memoized and uses deferred code updates to maintain UI responsiveness.
 * Internal debouncing is removed in favor of useDeferredValue in the parent.
 */
