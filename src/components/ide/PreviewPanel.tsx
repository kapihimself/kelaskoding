...
/**
 * PreviewPanel renders the live output of the code.
 * Memoized to benefit from deferred value updates.
 */
export default React.memo(function PreviewPanel({ code, mode, output }: PreviewPanelProps) {
