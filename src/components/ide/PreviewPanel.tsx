...
/**
 * @performance
 * Memoized and designed to work with useDeferredValue for the 'code' prop.
 * This ensures that the preview update (which can be expensive due to iframe srcDoc)
 * doesn't block the UI thread during typing.
 */
