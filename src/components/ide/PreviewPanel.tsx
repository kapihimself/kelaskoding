...
/**
 * PreviewPanel renders the live output of the user's code.
 * Wrapped in React.memo and handles deferred value to prevent
 * expensive iframe reloads from blocking the main UI thread.
 */
