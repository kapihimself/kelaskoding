...
/**
 * PreviewPanel is memoized to avoid re-renders during rapid typing.
 * It uses an internal state for the preview document which only updates
 * when the 'code' prop changes, ensuring the iframe isn't constantly re-rendering.
 */
const PreviewPanel = React.memo(function PreviewPanel({ code, mode, output }: PreviewPanelProps) {
  console.log('[RENDER] PreviewPanel');
