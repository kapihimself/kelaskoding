...
/**
 * ⚡ Bolt Optimization:
 * PreviewPanel renders the live output.
 * Since Workspace now uses useDeferredValue for the 'code' prop,
 * we can remove the internal setTimeout debounce to make it more responsive
 * while still benefiting from React's concurrent rendering.
 */
const PreviewPanel = React.memo(({ code, mode, output }: PreviewPanelProps) => {
