...
/**
 * PERFORMANCE: Memoized and uses deferred code from parent to avoid blocking typing.
 * Iframe content updates are debounced by React's transition system via useDeferredValue.
 */
