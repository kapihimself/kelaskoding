...
/**
 * PreviewPanel is memoized and uses deferred code to reduce
 * total renders during high-frequency typing.
 */
const PreviewPanel = memo(function PreviewPanel({ code, mode, output }: PreviewPanelProps) {
  ...
  useEffect(() => {
    if (mode === 'html') {
      // Internal timeout removed in favor of useDeferredValue in parent
      setDoc(`
        <html>
          <head>
            <style>
