...
/** PERFORMANCE: React.memo combined with useDeferredValue in parent optimizes preview updates.
 * Removed internal setTimeout debounce in favor of idiomatic useDeferredValue-driven updates. */
