...
/**
 * PreviewPanel renders terminal output or live HTML preview.
 * Memoized to prevent expensive iframe re-renders on every keystroke.
 * Works best when coupled with useDeferredValue in the parent Workspace.
 */
