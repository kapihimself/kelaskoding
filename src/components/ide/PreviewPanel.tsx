...
/** PERFORMANCE: memoized to prevent re-renders unless specific props change.
 *  Note: code updates will still trigger renders here, but handled by internal debounce.
 */
