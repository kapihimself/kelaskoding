...
export default function PreviewPanel({ code, mode, output }: PreviewPanelProps) {
  /** PERFORMANCE: useMemo for doc instead of useEffect + useState ensures the preview document
   * is updated immediately with the deferred code value, avoiding an extra render cycle
   * while keeping the high-frequency typing path fast. */
