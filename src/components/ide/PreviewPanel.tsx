...
/**
 * PERFORMANCE: React.memo used in conjunction with useDeferredValue in Workspace.tsx
 * allows this component to update less frequently than the editor,
 * improving responsiveness during rapid typing.
 */
