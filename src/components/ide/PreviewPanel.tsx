...
/** PERFORMANCE: PreviewPanel uses useMemo to derive the iframe document from the deferred code.
 * This removes redundant re-renders and eliminates the need for manual setTimeout debouncing,
 * aligning with React 19's transition and deferred value model.
 */
