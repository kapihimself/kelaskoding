...
/**
 * PreviewPanel is memoized and uses useMemo for the iframe document
 * to avoid unnecessary re-calculations. It relies on useDeferredValue
 * from the parent Workspace for throttling updates.
 */
