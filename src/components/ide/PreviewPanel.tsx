...
/** PERFORMANCE: Combined with useDeferredValue in the parent, this memoization
 * allows the preview to skip urgent render cycles and update during idle periods. */
