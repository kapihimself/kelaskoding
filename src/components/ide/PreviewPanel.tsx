...
/**
 * PreviewPanel is memoized to prevent expensive re-renders on every keystroke.
 * It uses useMemo for the doc generation to keep the rendering synchronous and predictable,
 * relying on useDeferredValue in the parent Workspace to handle throttling.
 */
