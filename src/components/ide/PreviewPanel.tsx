...
/**
 * PreviewPanel is memoized and uses useDeferredValue (from parent) to prevent
 * expensive iframe re-renders on every keystroke. Internal debouncing is
 * removed in favor of React's native deferred updates.
 */
