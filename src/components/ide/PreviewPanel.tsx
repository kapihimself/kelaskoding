...
/**
 * PERFORMANCE: Wrapped in React.memo and used with useDeferredValue in the parent.
 * This ensures that live preview updates don't block the main thread during typing,
 * and the component only re-renders when the (deferred) code or output changes.
 */
