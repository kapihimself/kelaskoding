...
/**
 * Optimized with React.memo and useDeferredValue (passed from parent).
 * Internal debouncing (setTimeout) has been removed in favor of React 19's useDeferredValue,
 * which provides a more responsive typing experience by prioritizing UI updates.
 */
