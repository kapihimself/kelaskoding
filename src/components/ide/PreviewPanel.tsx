...
/**
 * PreviewPanel renders the code preview (HTML) or terminal output.
 * Wrapped in React.memo and uses useMemo for doc generation to optimize rendering.
 * Now relies on deferred value from parent instead of internal setTimeout.
 */
