...
/**
 * PreviewPanel renders the live preview for HTML or the terminal output for Python.
 * Wrapped in React.memo to prevent redundant re-renders. It uses deferred code from the parent.
 */
