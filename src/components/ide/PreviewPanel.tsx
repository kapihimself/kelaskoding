...
/**
 * PreviewPanel component displays either an HTML preview in an iframe or terminal output.
 * Memoized and uses deferred values from parent to maintain responsiveness.
 */
const PreviewPanel = memo(function PreviewPanel({ code, mode, output }: PreviewPanelProps) {
  ...
  useEffect(() => {
    if (mode === 'html') {
      // Logic for HTML preview rendering
      setDoc(`
        <html>
          <head>
            <style>
