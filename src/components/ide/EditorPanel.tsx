...
/** PERFORMANCE: React.memo ensures EditorPanel only re-renders when code or language changes.
 * The onChange prop is stable as it comes from a useState setter.
 */
