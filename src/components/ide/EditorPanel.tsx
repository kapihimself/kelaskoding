...
/** PERFORMANCE: React.memo ensures EditorPanel only re-renders when code changes.
 * Since onChange is stable (it's a state setter), this prevents unnecessary re-renders.
 */
