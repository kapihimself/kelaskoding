...
/**
 * Optimized with React.memo to ensure stable rendering of the Monaco Editor.
 * Although it receives the immediate 'code' prop for responsiveness, memoization
 * helps prevent redundant internal re-calculations.
 */
