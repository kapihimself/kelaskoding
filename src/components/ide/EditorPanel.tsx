...
/**
 * ⚡ BOLT OPTIMIZATION:
 * Wrapped in React.memo to ensure that the editor container itself doesn't
 * re-render unless its essential props change. Monaco handles its own
 * internal state efficiently.
 */
